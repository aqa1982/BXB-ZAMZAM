...
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' 
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : LB OSAMA
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSAPP : +218912537778
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : OSAMA-ZAMZAM
...
\033[1;90m══════════════════════════════════════════════════
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ FERDOUS-OK:%s ]- \033[0;91m[FERDOUS-CP:%s ]" % (
...
if len(sys.argv) == 2:
    if sys.argv[1] == "--info":
        ...
        print(" [*] Team      :  \n")
        print(" [ Sosial Medi  ] \n")
        print(" [*] Facebook  : https://www.facebook.com/profile.php?id=100024557781911 ")
        print(" [*] Instagram : https://instagram.com/aqa1982")
        print(" [*] YouTube   : https://youtube.com/UCA7seogGnlrzMUPw8JJILWw")
        exit(" [*] GitHub    : https://github.com/aqa1982")
    else:
        Main()
